...
import { Product, Brand } from "@/src/interfaces";
import { ProductCard } from "@/src/components/products/ProductCard";
import { LoadingSpinner } from "@/src/components";
import { Button } from "@/src/components/ui/button";
import { Grid, List, ArrowLeft } from "lucide-react";
import { ProductsResponse, SingleBrandResponse } from "@/src/types/responses";
  ...
  async function fetchBrandAndProducts() {
    ...
    try {
      const [brandData, productsData] = await Promise.all([
        apiServices.getBrandDetails(String(id)),
        apiServices.getProductsByBrand(String(id))
      ]);
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <Button onClick={fetchBrandAndProducts}>Try Again</Button>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-6 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Discover amazing products from {brand.name}
            </p>
